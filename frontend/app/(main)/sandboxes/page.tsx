      ...
      <div className="bg-primary-fixed/5 border border-primary-fixed/20 rounded-xl p-5 mb-8 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-on-surface-variant leading-relaxed">
            Sandboxes give you a full Web IDE to view and edit code in real-time. Any file changes you save will automatically hot-reload the container. If you are looking for immutable production deployments, check the <Link href="/dashboard" className="text-primary-fixed underline decoration-primary-fixed/30 hover:decoration-primary-fixed transition-colors">Deployments page</Link>.
          </p>
        </div>
      </div>
