...
func Register(c *gin.Context) {
	c.JSON(http.StatusBadRequest, gin.H{"error": "Registration via email/password is disabled. Please use GitHub to sign up."})
}

func Login(c *gin.Context) {
	c.JSON(http.StatusBadRequest, gin.H{"error": "Login via email/password is disabled. Please use GitHub to log in."})
}
